...
void ap_state_config_default_set(void)
{
	...
	ap_state_config_voice_record_switch_set(0); //mic on
#if Resolution_1080P == 1
	ap_state_config_video_resolution_set(1);	//1080P
#else
	...
	ap_state_config_pic_size_set(8);//8--1280*720
