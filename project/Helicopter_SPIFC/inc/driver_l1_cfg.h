...
///#define RAM_END_ADDR              (RAM_ADDR - (120*1024) - 1)
#define RAM_END_ADDR              (RAM_ADDR - 1)
...
#define TV_WIDTH					720///640
#define TV_HEIGHT					480///480
...
#define NAND_DATA_DRIVING           IO_DRIVING_4mA
      ...
      #if SUPPORT_JTAG
          #define UART_TX_RX_POS              UART1_TX_IOB7__RX_IOB6///UART1_TX_IOC15__RX_IOC14///UART1_TX_IOB7__RX_IOB6//////	
      #else
...
//=== This is for code configuration DON'T REMOVE or MODIFY it =============================//
   ...
   #define EXT_INT_POS                 EXT_INT_ABC_IOB8_10        	
  //============================================================
